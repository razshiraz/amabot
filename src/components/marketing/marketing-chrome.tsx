  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      <div className="mx-auto mt-4 max-w-6xl px-4">
        <div className="rounded-2xl border border-border/60 bg-background/70 px-3 py-3 backdrop-blur-2xl md:px-5 md:py-4">
          <div className="flex items-center justify-between gap-2">
            <Logo size="lg" />

            <nav aria-label="Main" className="hidden items-center gap-6 text-base text-white/90 lg:flex lg:gap-8 lg:text-lg lg:font-medium">
              <Link
                to="/"
