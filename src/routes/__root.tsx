...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AmaBot | Amazon Auto Buy Bot & Deal Alerts" },
      { name: "description", content: "AmaBot helps users track Amazon deals, limited drops, and fast-selling products with real-time alerts and ultra-fast auto buying. Never miss a restock again." },
      { name: "author", content: "AmaBot" },
      { property: "og:title", content: "AmaBot | Amazon Auto Buy Bot & Deal Alerts" },
      { property: "og:description", content: "AmaBot helps users track Amazon deals, limited drops, and fast-selling products with real-time alerts and ultra-fast auto buying. Never miss a restock again." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "AmaBot | Amazon Auto Buy Bot & Deal Alerts" },
